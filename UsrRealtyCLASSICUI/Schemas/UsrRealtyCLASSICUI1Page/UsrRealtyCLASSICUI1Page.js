define("UsrRealtyCLASSICUI1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		details: /**SCHEMA_DETAILS*/{
			...
			"UsrSchemad7786109Detail8484d283": {
				"schemaName": "UsrSchemad7786109Detail",
		...
		methods: {
			...
			onRunWebServiceButtonClick: function() {
				...
				var offerTypeObject = this.get("UsrRealtyOffer");
				if (!offerTypeObject) {
					return;
				}
				...
				var params = {
					...
					entityName: "UsrRealtyCLASSICUI"
				};				
				this.console.log("1");
				ServiceHelper.callService("UsrRealtyServiceCLASSICUI", "GetTotalAmountByTypeId", this.getWebServiceResult, params, this);
				this.console.log("2");
			},
		...
		diff: /**SCHEMA_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "Tab9f6b74fcTabLabel",
				"values": {
					"caption": {
						"bindTo": "Resources.Strings.Tab9f6b74fcTabLabelTabCaption"
					},
					"items": [],
					"order": 0
				},
			...
			{
				"operation": "insert",
				"name": "UsrSchemad7786109Detail8484d283",
				"values": {
					"itemType": 2,
					"markerValue": "added-detail"
				},
				"parentName": "Tab9f6b74fcTabLabel",
				"propertyName": "items",
				"index": 0
			},
			{
